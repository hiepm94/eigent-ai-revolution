...
import { WorkflowPanel } from '@/components/ChatBox/WorkflowPhase';
              ...
              {chatStore.tasks[chatStore.activeTaskId as string]
                ...
                <div className="flex h-full w-full flex-1 flex-col pr-2 duration-300 animate-in fade-in-0 slide-in-from-right-2">
                  ...
                  {chatStore.tasks[chatStore.activeTaskId as string]
                    ...
                    <div className="flex h-full w-full flex-1 items-center justify-center duration-300 animate-in fade-in-0 slide-in-from-right-2">
                      <div className="relative flex h-full w-full flex-col overflow-y-auto rounded-2xl border border-solid border-transparent p-2">
                        <div className="relative z-10">
                          <WorkflowPanel
                            taskId={chatStore.activeTaskId as string}
                            chatStore={chatStore}
                            projectId={projectStore.activeProjectId as string}
                          />
                        </div>
                      </div>
                    </div>
