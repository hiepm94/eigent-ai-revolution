...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.List
		ref={ref}
		className={cn(
			"inline-flex items-center justify-center bg-muted p-1 text-muted-foreground bg-menutabs-bg-default rounded-xl border border-solid border-menutabs-border-default",
